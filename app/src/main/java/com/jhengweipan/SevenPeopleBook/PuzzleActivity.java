...
public class PuzzleActivity extends Activity {
    ...
    private String url = "http://nmn.joybomb.com.tw/mobile/newscontent?gid=38&type=16&id=8697";
    @Override
    ...
    private void initLayout() {
        MyGAManager.sendScreenName(PuzzleActivity.this, getString(R.string.ga_Befall));
