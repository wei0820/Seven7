...
public class TeacherActivity extends Activity {
    private String url = "http://www.mobirum.com/article/list?bbsId=666&cafeId=sevenknights_zh-tw";
    ...
    private void initLayout() {
        MyGAManager.sendScreenName(TeacherActivity.this, getString(R.string.ga_teacher));
    ...
    private void addAd() {
        {
            boolean isbuy= MySharedPrefernces.getIsBuyed(TeacherActivity.this);
