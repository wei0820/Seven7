...
public class AnsActivity extends Activity {
    ...
    private String url = "http://www.mobirum.com/article/list?bbsId=1545&cafeId=sevenknights_zh-tw";
    @Override
    ...
    private void initLayout() {
        MyGAManager.sendScreenName(AnsActivity.this, getString(R.string.ga_Befall));
    ...
    private class MyWebViewClient extends WebViewClient {
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            mProgressDialog = new ProgressDialog(AnsActivity.this);
